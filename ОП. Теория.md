...
<ul>
<li><a href="#основы-программирования.-теория">Основы программирования. Теория</a></li>
<li><a href="#синтаксис-и-семантика-языков-программирования.-алфавит-языка-delphi-pascal.-cинтаксические-диаграммы">Синтаксис и семантика языков программирования. Алфавит языка Delphi Pascal. Cинтаксические диаграммы</a></li>
<li><a href="#представление-данных-в-delphi-pascal-константы-и-переменные">Представление данных в Delphi Pascal: константы и переменные</a>
<ul>
<li><a href="#представление-данных">Представление данных</a></li>
</ul>
</li>
<li><a href="#классификация--скалярных-типов-данных-операции-над-ними">Классификация  скалярных типов данных, операции над ними</a>
<ul>
<li><a href="#классификация-типов-данных-языка">Классификация типов данных языка</a>
<ul>
<li>
<ul>
<li>
...
<li><a href="#процедуры-и-функции-порядковых-типов-данных">Процедуры и функции порядковых типов данных</a></li>
<li><a href="#операции-над-скалярными-типами-данных.">Операции над скалярными типами данных.</a></li>
<li><a href="#математические-функции">Математические функции</a></li>
<li><a href="#совместимость-типов-данных-и-операции-преобразования-типов">Совместимость типов данных и операции преобразования типов</a></li>
<li><a href="#условный-оператор----оператор-условной-передачи-управления----if-...-else">Условный оператор – оператор условной передачи управления – if ... else</a></li>
<li><a href="#оператор-выбора----case">Оператор выбора – case</a></li>
<li><a href="#операторы-циклов-delphi-pascal">Операторы циклов Delphi Pascal</a></li>
<li><a href="#поисковый-цикл.-неструктурная-и-структурная-реализации-поискового-цикла.">Поисковый цикл. Неструктурная и структурная реализации поискового цикла.</a></li>
<li><a href="#массивы-delphi-pascal">Массивы Delphi Pascal</a></li>
<li><a href="#строки-delphi-pascal">Строки Delphi Pascal</a></li>
<li><a href="#множества-delphi-pascal">Множества Delphi Pascal</a></li>
<li><a href="#записи-delphi-pascal">Записи Delphi Pascal</a>
<ul>
<li>
<ul>
<li>
...
<li><a href="#операции-над-записями">Операции над записями</a></li>
</ul>
</li>
<li><a href="#процедуры-и-функции.-определение-описание-особенности.-примеры.">Процедуры и функции. Определение, описание, особенности. Примеры.</a></li>
<li><a href="#структурные-типы-параметров-параметры-строки-параметры-массивы.">Структурные типы параметров: параметры-строки, параметры-массивы.</a></li>
<li><a href="#принципы-разработки-универсальных-подпрограмм">Принципы разработки универсальных подпрограмм</a></li>
<li><a href="#модули-delphi-pascal">Модули Delphi Pascal</a></li>
<li><a href="#рекурсия">Рекурсия</a></li>
<li><a href="#динамическая-память">Динамическая память</a></li>
<li><a href="#динамические-структуры-данных">Динамические структуры данных</a></li>
<li><a href="#списковые-структуры-данных.-классификация-и-основные-приемы-работы-с-ними-создание-элемента-добавление-элемента-к-списку-удаление-элемента-из-списка.-область--применения-списковых-структур-данных.-пример.">21. Списковые структуры данных. Классификация и основные приемы работы с ними: создание элемента, добавление элемента к списку, удаление элемента из списка. Область  применения списковых структур данных. Пример.</a></li>
<li><a href="#работа-с-файлами">Работа с файлами</a></li>
<li><a href="#основы-файловой-системы-файл-каталог-дисковод-полное-имя-файла-внутреннее-представление-информации-в-файле.-файловая-переменная.-операции-открытия-и-закрытия-файлов.-примеры.">22. Основы файловой системы: файл, каталог, дисковод, полное имя файла, внутреннее представление информации в файле. Файловая переменная. Операции открытия и закрытия файлов. Примеры.</a></li>
<li><a href="#текстовые-файлы.-внутреннее-представление-информации-в-файле.-операции-над--файлами.-пример.">23. Текстовые файлы. Внутреннее представление информации в файле. Операции над  файлами. Пример.</a></li>
<li><a href="#типизированные-файлы-внутреннее-представление-информации-в-файле.-операции--над-файлами.-пример.">24. Типизированные файлы: внутреннее представление информации в файле. Операции  над файлами. Пример.</a></li>
<li><a href="#нетипизированные-файлы.-внутреннее-представление-информации-в-файле.-операции-над-файлами.-пример.">25. Нетипизированные файлы. Внутреннее представление информации в файле. Операции над файлами. Пример.</a></li>
</ul>
</li>
<li><a href="#объектно-ориентированное-программирование">Объектно-ориентированное программирование</a>
<ul>
<li><a href="#история">История</a></li>
<li><a href="#диаграмма-состояний-интерфейса">Диаграмма состояний интерфейса</a></li>
<li><a href="#структурная-декомпозиция">Структурная декомпозиция</a></li>
<li><a href="#объектная-декомпозиция">Объектная декомпозиция</a></li>
<li><a href="#объект-предметной-области">Объект предметной области</a></li>
<li><a href="#методы-построения-классов">Методы построения классов</a></li>
<li><a href="#средства-объектно-ориентированного-программирования">Средства объектно-ориентированного программирования</a></li>
<li><a href="#простой-полиморфизм">Простой полиморфизм</a></li>
<li><a href="#сложный-полиморфизм.-конструкторы">Сложный полиморфизм. Конструкторы</a></li>
<li><a href="#динамические-полиморфные-объекты.-деструкторы">Динамические полиморфные объекты. Деструкторы</a></li>
</ul>
</li>
<li><a href="#технология-событийного-программирования.-события-windows-сообщения-и-события-delphi.-основные-события-delphi.-примеры.">Технология событийного программирования. События Windows, сообщения и события Delphi. Основные события Delphi. Примеры.</a>
<ul>
...
<li><a href="#ещё-полезные-вещи">Ещё полезные вещи</a>
<ul>
<li><a href="#некоторые-опциидирективы-компилятора">Некоторые опции/директивы компилятора</a>
<ul>
<li>
<ul>
<li>
...
<pre class=" language-pascal"><code class="prism  language-pascal"><span class="token punctuation">[</span><span class="token punctuation">]</span> <span class="token operator">-</span><span class="token operator">-</span> пустое множество<span class="token punctuation">;</span>
<span class="token punctuation">[</span><span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">,</span> <span class="token number">5</span><span class="token punctuation">,</span> <span class="token number">7</span><span class="token punctuation">,</span> <span class="token number">11</span><span class="token punctuation">]</span> <span class="token operator">-</span><span class="token operator">-</span> множество чисел<span class="token punctuation">;</span>
<span class="token punctuation">[</span>’a’<span class="token punctuation">,</span> ’d’<span class="token punctuation">,</span> ’f’<span class="token punctuation">,</span> ’h’<span class="token punctuation">]</span> <span class="token operator">-</span><span class="token operator">-</span> множество символов<span class="token punctuation">;</span>
<span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">,</span> k<span class="token punctuation">]</span> <span class="token operator">-</span><span class="token operator">-</span> множество чисел<span class="token punctuation">,</span> переменная k должна содержать число<span class="token punctuation">;</span>
<span class="token punctuation">[</span><span class="token number">2</span><span class="token operator">..</span><span class="token number">100</span><span class="token punctuation">]</span> <span class="token operator">-</span><span class="token operator">-</span> множество содержит целые числа из указанного интервала<span class="token punctuation">;</span>
<span class="token punctuation">[</span>k<span class="token operator">..</span><span class="token number">2</span> <span class="token operator">*</span> k<span class="token punctuation">]</span> <span class="token operator">-</span><span class="token operator">-</span> интервал можно задать выражениями<span class="token punctuation">;</span>
...
<div class="mermaid"><svg xmlns="http://www.w3.org/2000/svg" id="mermaid-svg